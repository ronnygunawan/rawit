...
import rg.rawit.processors.merge.MergeTreeBuilder;
import rg.rawit.processors.model.AnnotatedMethod;
import rg.rawit.processors.model.MergeTree;
import rg.rawit.processors.model.OverloadGroup;
import rg.rawit.processors.model.Parameter;
import rg.rawit.processors.validation.ElementValidator;
import rg.rawit.processors.validation.ValidationResult;
...
public class RawitAnnotationProcessor extends AbstractProcessor {
    ...
    private AnnotatedMethod buildAnnotatedMethod(final ExecutableElement exec) {
        ...
        final boolean isConstructorAnnotation = exec.getAnnotation(rg.rawit.Constructor.class) != null;
